...
const localConfig: LocalConfig = {
  ...
  "navBar": {
    ...
    "textColor": "#f5d6d6",
    "logo": "TC-TITLE.png",
    "siteTitle": "*ENTER_NAM E*",
    "siteTitleGradientFrom": "#f5d6d6",
    "siteTitleGradientTo": "#e69999",
    "scheduleButtonText": "*CALL_TO_ACTION*",
    "scheduleButtonColor": "#f8aaaa",
  ...
  "pages": {
    "Home": {
      ...
      "heroImage": "pink_templates.png",
      "heroGradientColor": "#f3a1a1",
      "heroRadialColor": "#f8aaaa",
      "heroGradientTop": "#f8aaaa",
      "heroGradientMiddle": "#f5d6d6",
      "heroGradientBottom": "#f5d6d6",
      "heroGradientLeft": "#f8aaaa",
      "heroBadgeColor": "#f5d6d6",
      "heroBadgeTitleColor": "#a18282",
      "heroTitleColor": "#f9fafb",
      ...
      "subtitle": "",
      "heroOverlayColor": "#b80000",
      "scheduleButtonColor": "#c9ba18",
      "heroCard1Text": "Hero Card1 Text",
      "heroCard2Text": "Hero Card2 Text",
      "heroCard3Text": "Hero Card3 Text",
  ...
  "copyright": "© 2025 Davis Tree Removal. All rights reserved.",
  "footerStyle": {
    "backgroundColor": "#ffffff",
    "gradientFromColor": "rgba(5, 5, 5, 1.00)",
    "gradientToColor": "rgba(5, 5, 5, 1.00)",
    "titleColor": "rgba(238, 191, 191, 1.00)",
    "textColor": "rgba(255, 255, 255, 1.00)",
    "linkColor": "rgba(240, 240, 240, 1.00)",
    "linkHoverColor": "rgba(238, 191, 191, 1.00)",
    "socialIconColor": "rgba(238, 191, 191, 1.00)",
    "dividerColor": "rgba(253, 201, 201, 0.20)",
    "quickLinksTitleColor": "rgba(238, 191, 191, 1.00)",
    "contactInfoTitleColor": "rgba(238, 191, 191, 1.00)",
    "infoTitleColor": "rgba(238, 191, 191, 1.00)",
    "joinButtonBgColor": "rgba(238, 191, 191, 1.00)",
    "joinButtonTextColor": "rgba(3, 3, 3, 1.00)",
    "joinButtonHoverBgColor": "rgba(219, 191, 191, 1.00)",
    "hoursCardBgColor": "rgba(245, 245, 245, 0.04)",
    "hoursCardTextColor": "rgba(245, 245, 245, 1.00)",
    "hoursCardValueColor": "rgba(238, 191, 191, 1.00)",
    "copyrightTextColor": "#6b7280",
    "policyLinkColor": "rgba(240, 240, 240, 1.00)",
    "policyLinkHoverColor": "rgba(238, 191, 191, 1.00)"
  },
